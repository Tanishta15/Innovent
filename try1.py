#Load the dataset.
#Perform demand forecasting for a specific product.
#Calculate the Economic Order Quantity (EOQ) and safety stock.
#Evaluate supplier performance.
#Optimize transportation routes.
#Schedule production tasks.
#Assess and visualize supply chain risks.
...
# Load the dataset
df = pd.read_csv('supply_chain_optimization_dataset.csv')
